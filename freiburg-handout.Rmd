---
title: "Few remaining issues with current workflows"
...
bibliography: [~/FRibliography/bibtex/FRibliography.bib, /Volumes/langdoc/compile_corpus/sessions.bib]
link-citations: yes
---
...
Or:
    ...
    @incollection{KSDP,
        ...
        Date-Added = {2010-07-27 14:26:38 +0200},
        Date-Modified = {2015-06-19 17:59:30 +0000},
...
> Finnish dialect spoken around Mikkeli, Savo, is the most beautiful variant of any Finnic language. For reference, see this narrative about skinning a squirrel [@skn-mikkeli-example].

Now if you click that link, which I also put [here](https://lat.csc.fi/ds/annex/runLoader?handle=hdl:11113/00-0000-0000-0000-1DDE-2&time=3618237&duration=39096&viewType=timeline) as in PDF it goes to the bottom (in HTML it should be in the side), one should get that segment open.
