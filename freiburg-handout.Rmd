...
- Reuse of corpus raw data -- getting exact about how files go together
...
PDF version of this same can be found from [here](https://nikopartanen.github.io/freiburg-handout/partanen-freiburg-handout.pdf). 
